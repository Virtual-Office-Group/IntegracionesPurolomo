---
title: 'Integraciones Para importacion de Nomina'
...
<LinkCard
  title="Ejemplo diario general"
  href="../../../../public/ExampleGeneralJournal.txt"
  target={'_blank'}
  download={"ExampleGeneralJournal.txt"}
/>

<LinkCard
  title="Ejemplo diario de pago"
  href="../../../../public/ExamplePaymentJournal.txt"
  target={'_blank'}
  download={"ExamplePaymentJournal.txt"}
/>

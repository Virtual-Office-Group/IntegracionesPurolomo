...
- Despues de obtener la información de nómina, se realizará un proceso de validación para asegurar que los datos sean correctos y completos para ser insertados en los diarios de pagos.
